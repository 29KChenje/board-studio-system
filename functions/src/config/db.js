...
const getCredential = () => {
  ...
  try {
    ...
    throw new Error(
      "Firebase credentials are missing. Configure Firebase Functions credentials or populate FIREBASE_PROJECT_ID, FIREBASE_CLIENT_EMAIL, and FIREBASE_PRIVATE_KEY in environment variables."
    );
  }
};
